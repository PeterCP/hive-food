    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <section class="content-header">
                <h1>
                    <strong style="text-transform: uppercase;">Historial de Efectivo</strong>
                </h1>
                <ol class="breadcrumb">
                    <li>
                        <a href="{{ URL::route('cash') }}">
                            <i class="fa fa-list-ul"></i>Efectivo</a>
                    </li>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">
                                    Aquí puedes ver el historial del los registros de los prepagos de efectivo.
                                </h3>
                            </div>
                            <!-- /.box-header -->
