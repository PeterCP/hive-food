    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <section class="content-header">
                <h1>
                    <strong style="text-transform: uppercase;">Fidelidad</strong>
                </h1>
                <ol class="breadcrumb">
                    <li>
                        <a href="{{ URL::route('loyalty') }}">
                            <i class="fa fa-list-ul"></i>Fidelidad</a>
                    </li>
                    <li class="active">Fidelidad</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">
                                    Aquí puedes administrar los puntos de fidelidad de los comensales.
                                </h3>
                            </div>
                            <!-- /.box-header -->
                            <section class="box-body">
                                ...
                                <table id="users_table" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>Nombre</th>
                                        <th>Puntos</th>
                                        <th>Canjear Puntos</th>
                                        <th>Aumentar Puntos</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($clients as $client)
                                        <tr>
                                            <td>{{$client->id}}</td>
                                            <td>{{$client->name}}</td>
                                            <td style="text-align: center">{{$client->loyalty_points}}</td>

                                            @if($client->loyalty_points >= 7)
        ...
        $(document).ready(function () {
            ...
            $('.reducePrepayment').on('click', function (event) {
                ...
                iziToast.warning({
                    ...
                    id: 'question',
                    zindex: 999,
                    title: 'Canjear puntos de fidelidad.',
                    message: `¿Canjear 7 puntos de fidelidad de ${username}?`,
                    position: 'center',
                    buttons: [
                        ['<button><b>Si</b></button>', function (instance, toast) {
                            instance.hide({transitionOut: 'fadeOut'}, toast, 'button');
                            window.location = '{{ url('admin/loyalty/redeem') }}/' + userId;
                        }, true],
            ...
            $('.addPrepayment').on('click', function (event) {
                ...
                iziToast.question({
                    ...
                    toastOnce: false,
                    id: 'question',
                    title: `Aumentar puntos de fidelidad de ${username}`,
                    message: '¿Cuantos puntos de fidelidad deseas agregar?',
                    position: 'center',
                    inputs: [
                    ...
                    buttons: [
                        ['<button><b>Confirmar</b></button>', function (instance, toast, button, e, inputs) {
                            ...
                            if(number > 0){
                                window.location = '{{ url('admin/loyalty/add') }}/' + userId + '/' + number;
                            }
                            instance.hide({transitionOut: 'fadeOut'}, toast, 'button');
                        }, false], // true to focus
