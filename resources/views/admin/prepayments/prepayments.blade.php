    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <section class="content-header">
                <h1>
                    <strong style="text-transform: uppercase;">Comidas</strong>
                </h1>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">
                                    Aquí puedes administrar los prepagos de comidas los comensales.
                                </h3>
                            </div>
                            <!-- /.box-header -->
                            <section class="box-body">
                                ...
                                <table id="users_table" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>Disminuir Comidas</th>
                                        <th>Aumentar Comidas</th>
                                        <th>Ver Historial</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($clients as $client)
                                        <tr>
                                            <td>{{$client->id}}</td>
                                            <td>{{$client->name}}</td>
                                            <td style="text-align: center">{{$client->prepayments}}</td>

                                            @if($client->prepayments > 0)
                                            ...
                                            <td style="text-align: center">
                                                <a href="{{ url("admin/prepayment/history/$client->id") }}"
        ...
        $(document).ready(function () {
            ...
            $('.reducePrepayment').on('click', function (event) {
                ...
                iziToast.warning({
                    ...
                    zindex: 999,
                    title: 'Confirmación',
                    message: `¿Disminuir el numero de pregagos de ${username}?`,
                    position: 'center',
                    buttons: [
                        ['<button><b>Si</b></button>', function (instance, toast) {
                            instance.hide({transitionOut: 'fadeOut'}, toast, 'button');
                            window.location = '{{ url('admin/prepayment/reduce') }}/' + userId;
                        }, true],
            ...
            $('.addPrepayment').on('click', function (event) {
                ...
                iziToast.question({
                    ...
                    toastOnce: false,
                    id: 'question',
                    title: `Aumentar prepagos de ${username}`,
                    message: '¿Cuantos pregagos deseas agregar?',
                    position: 'center',
                    inputs: [
                    ...
                    buttons: [
                        ['<button><b>Confirmar</b></button>', function (instance, toast, button, e, inputs) {
                            ...
                            if(number > 0){
                                window.location = '{{ url('admin/prepayment/add') }}/' + userId + '/' + number;
                            }
                            instance.hide({transitionOut: 'fadeOut'}, toast, 'button');
                        }, false], // true to focus
